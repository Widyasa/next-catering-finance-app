...
export const detailOrderSchema = z.object({
    ...
    total_price: z.coerce.number().min(1, {
        message: "transaction price is cannot be 0"
    }),
    total_income: z.coerce.number().min(1, {
        message: "transaction income is cannot be 0"
    }),
    total_outcome: z.coerce.number().min(1, {
        message: "transaction outcome is cannot be 0"
    }),
